...
void loop() { 
  ...
  ssd1306_char_f6x8(0, 4, "dhiraj "); // see comments above !
  ...
  ssd1306_char_f6x8(0, 6, "by gr8vilen");
  ssd1306_char_f6x8(0, 7, "gr8vilen.com");
  delay(1500);
  ssd1306_char_f6x8(0, 6, "cyfoxgen ");
  ssd1306_char_f6x8(0, 7, "cyfoxgen.in");  // see comments above - f has been replaced by @ in the ASCII table
